...
int _tmain(int argc, _TCHAR* argv[])
{
	...
	std::string pfad_auswertung = "C:\\Users\\Wolfgang2\\Desktop\\Auswertung\\EX2 C\\";
	...
	bezer[17]="swirski";
	bezer[18]="data set XVIII";
	bezer[19]="data set XIX";
	bezer[20]="data set XX";
	bezer[21]="data set XXI";
	bezer[22]="data set XXII";
	bezer[23]="data set XXIII";
	bezer[24]="data set XXIV";

	int size_data_sets[25];
	...
	size_data_sets[18]=10794;
	size_data_sets[19]=13474;
	size_data_sets[20]=10344;
	size_data_sets[21]=9133;
	size_data_sets[22]=10370;
	size_data_sets[23]=636;
	size_data_sets[24]=961;
...
//Zieldatei.open(pfad_auswertung+bezer[kk]+".txt",std::fstream::in | std::fstream::out | std::fstream::trunc); 
...
std::string path_images1 = pfad+bezer[kk]+"\\"+str_number+".png";
	...
	sum_all+=zeit2-zeit1;
		...
		//akt_dist=ceil(akt_dist);
		if(akt_dist<=5) corr5++;
		//else std::cout<<str_number<<"     er:"<<akt_dist<<std::endl;
		//else Zieldatei<<str_number<<"     er:"<<akt_dist<<std::endl;
		//if(akt_dist>10) std::cout<<str_number<<std::endl;

//		Zieldatei<<akt_dist<<std::endl;
